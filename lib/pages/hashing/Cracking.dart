    ...
    return Column(
      children: [
        buildCustomInputField(
            true, "write something", _input, inputHeight, true, true, this),
        _getDropdownButton(),
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 12),
          child: Text(
            "Crack using a 5M words dictionary.",
  ...
  void _startCracking(BuildContext context) async {
    ...
    CustomHashing.loadAsset().then((value) async {
      ...
      for (int i = 0; i < dic.length / 10000; i++) {
        CrackingInput input = CrackingInput(
            dropdownValue, _input.text.trim(), dic, i * 10000, (i + 1) * 10000);
