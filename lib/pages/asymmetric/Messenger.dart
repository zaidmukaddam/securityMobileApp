...
class _MessengerUIState extends State<MessengerUI> {
      ...
      builder: (BuildContext context) => UserListDialog(
        callback: (person) {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    DiscussionUI(person, userName, _getPublicKey(person))),
          );
        },
        users: users,
      ),
  ...
  void initRoom() async {
    ...
    Provider.of<MessagingService>(context, listen: false)
        .initPrivateKey(preferences.getString('privateKey'));
  }
  ...
  Widget discussionItemBuilder(BuildContext context, int index) {
    ExtendedMessage message =
        Provider.of<MessagingService>(context).discussions.elementAt(index);
    String sender =
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    DiscussionUI(sender, userName, _getPublicKey(sender))),
          );
        },
        child: Card(
