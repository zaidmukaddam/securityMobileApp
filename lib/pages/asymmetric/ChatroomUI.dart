...
class _DiscussionUIState extends State<DiscussionUI> {
  ...
  void _sendMessage() async {
    Provider.of<MessagingService>(context, listen: false)
        .sendMessage(_message.text, widget.person, isAsync: true);
    _message.text = "";
  }
  ...
  Widget _getMessageList() {
    return Padding(
      ...
      child: ListView.builder(
          ...
          itemCount: Provider.of<MessagingService>(context)
              .getMessagesForChatID(widget.person)
              .length,
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => MessageDetailAsymUI(
                    message: message,
  ...
  Widget itemBuilder(BuildContext context, int index) {
    Message message = Provider.of<MessagingService>(context, listen: false)
        ...
        .elementAt(index);
    Widget mess;
    if (message.senderID == widget.username)
