...
class MessageDetailSymUI extends StatefulWidget {
  ...
  const MessageDetailSymUI({Key key, this.message, this.password})
      : super(key: key);
  @override
...
class _MessageDetailSymUIState extends State<MessageDetailSymUI> {
  ...
  getBody() {
    ...
    _message.text =
        SymmetricUtil.decrypt(" ", widget.message.text, widget.password);
    return Container(
      child: Column(
        ...
        children: [
          ...
          buildCustomInputField(
              false, "Your Message", _raw, inputHeight, true, false, this),
          Text(
            "Decrypted Message: ",
            style: buttonStyle,
          ),
          buildCustomInputField(
              false, "Your Message", _message, inputHeight, true, false, this),
        ],
      ),
    );
  }
